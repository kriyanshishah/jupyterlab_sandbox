...
```bash
pip install jupyterlab_sandbox
```
...
```bash
pip uninstall jupyterlab_sandbox
```
...
# Change directory to the jupyterlab_sandbox directory
...
folder is located. Then you can remove the symlink named `iframe-jupyterlab` within that folder.
